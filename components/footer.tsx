export default function Footer() {
  return (
    <footer className="py-12 bg-gradient-to-b from-black/90 to-black/95 border-t border-luxe/30 relative">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="text-2xl mb-4 md:mb-0 font-bold tracking-wide relative">

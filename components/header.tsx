  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-black/90 backdrop-blur-md border-b border-luxe/30 py-2"
          : "bg-black/80 backdrop-blur-sm border-b border-gray-800 py-4"
      }`}
    >
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center">
          ...
          <div
            className={`text-2xl md:text-3xl font-bold tracking-wide mb-2 relative ${
              scrolled ? "scale-90" : ""
          ...
          >
            ...
            <a href="#contact" className="gold-button px-4 py-2 rounded-md text-base relative overflow-hidden group">

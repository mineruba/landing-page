...
export default function Features() {
  return (
    <section className="py-20 md:py-28 bg-black/80" id="features">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-luxe-light via-luxe to-luxe-dark flex items-center justify-center mb-5 shadow-lg shadow-luxe/20 overflow-hidden border-2 border-luxe">
              <img
            ...
            <h3 className="text-xl font-semibold mb-3">マンツーマンでのサポート</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-3">AIを活用した学習</h3>
            <p className="text-gray-300">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-3">オリジナルの教材</h3>
            <p className="text-gray-300">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-10 max-w-5xl mx-auto mt-10">
          <div className="flex flex-col items-center text-center max-w-md">
            ...
            <h3 className="text-xl font-semibold mb-3">人に教える学習法</h3>
            <p className="text-gray-300">
          ...
          <div className="flex flex-col items-center text-center max-w-md">
            ...
            <h3 className="text-xl font-semibold mb-3">1冊の参考書を完璧にする</h3>
            <p className="text-gray-300">

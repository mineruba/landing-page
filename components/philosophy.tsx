export default function Philosophy() {
  return (
    <section className="py-20 md:py-28 relative" id="philosophy">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          {/* 自ら学ぶ力 */}
          <div className="bg-gradient-to-b from-black/80 to-black/60 backdrop-blur-sm border border-gray-800 p-10 rounded-lg hover:border-luxe hover:shadow-lg hover:shadow-luxe/10 transition-all duration-500 relative group">
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-luxe mb-4 shadow-lg shadow-luxe/20 group-hover:shadow-luxe/40 transition-all duration-500">
                <img
              ...
              <h3 className="text-2xl md:text-3xl font-semibold mb-2 text-luxe-light group-hover:text-luxe transition-colors duration-300">
                自ら学ぶ力
              </h3>
